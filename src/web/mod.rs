...
pub fn create_router(db: DbState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/agent-definitions/:id", axum::routing::put(api::update_agent_definition))
        .route("/api/agent-definitions/:id", delete(api::delete_agent_definition))
        ...
        .route("/api/teams/:name", delete(api::delete_team))
